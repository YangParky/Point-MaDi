...
from tools import test_net as test_net
...
def _init_(args):
    ...
    os.system('cp ./models/Point_MaDi.py ' + args.experiment_path + '/Point_MaDi.py')
    os.system('cp ./tools/runner_pretrain.py ' + args.experiment_path + '/runner_pretrain.py')
    os.system('cp ./cfgs/pretrain/pretrain.yaml ' + args.experiment_path + '/pretrain.yaml')
